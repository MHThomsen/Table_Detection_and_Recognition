...
class GeneralizedRPN(nn.Module):
    ...
    def forward(self, images, targets=None):
        ...
        detections = self.RPNpostprocess(proposals, images.image_sizes, original_image_sizes)
        
        #print("PROPOSALS",proposals)
        #print("LOSSES",proposal_losses)
        ...
        return self.eager_outputs(proposal_losses,detections)
